...
class AuthenticationError(openai.AuthenticationError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.AuthenticationError: {}".format(label,message)
    ...
    def __str__(self):
        ...
        if self.num_retries:
            _message += f" {label} Retried: {self.num_retries} times"
        if self.max_retries:
            _message += f", {label} Max Retries: {self.max_retries}"
        return _message
...
class NotFoundError(openai.NotFoundError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.NotFoundError: {}".format(label, message)
        self.model = model
        self.llm_provider = llm_provider
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
...
class UnprocessableEntityError(openai.UnprocessableEntityError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.UnprocessableEntityError: {}".format(label,message)
        self.model = model
        self.llm_provider = llm_provider
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
...
class Timeout(openai.APITimeoutError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.Timeout: {}".format(label, message)
        self.model = model
        self.llm_provider = llm_provider
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
...
class PermissionDeniedError(openai.PermissionDeniedError):  # type:ignore
    def __init__(
        ...
        self.message = "{}.PermissionDeniedError: {}".format(label, message)
        self.llm_provider = llm_provider
        self.model = model
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
...
class RateLimitError(openai.RateLimitError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.RateLimitError: {}".format(label, message)
        self.llm_provider = llm_provider
        self.model = model
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
...
class ContextWindowExceededError(BadRequestError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.ContextWindowExceededError: {}".format(label, self.message)
...
class RejectedRequestError(BadRequestError):  # type: ignore
    def __init__(
        ...
        self.status_code = 400
        self.message = "{}.RejectedRequestError: {}".format(label, message)
        self.model = model
        self.llm_provider = llm_provider
        self.litellm_debug_info = litellm_debug_info
...
class ContentPolicyViolationError(BadRequestError):  # type: ignore
    ...
    def __init__(
        ...
        self.status_code = 400
        self.message = "{}.ContentPolicyViolationError: {}".format(label, message)
        self.model = model
        self.llm_provider = llm_provider
        self.litellm_debug_info = litellm_debug_info
        request = httpx.Request(method="POST", url="https://api.openai.com/v1")
...
class ServiceUnavailableError(openai.APIStatusError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.ServiceUnavailableError: {}".format(label, message)
        self.llm_provider = llm_provider
        self.model = model
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
...
class InternalServerError(openai.InternalServerError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.InternalServerError: {}".format(label, message)
        self.llm_provider = llm_provider
        self.model = model
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
...
class APIError(openai.APIError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.APIError: {}".format(label, message)
        self.llm_provider = llm_provider
        self.model = model
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
...
class APIConnectionError(openai.APIConnectionError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.APIConnectionError: {}".format(label, message)
        self.llm_provider = llm_provider
        self.model = model
        self.status_code = 500
        self.litellm_debug_info = litellm_debug_info
...
class APIResponseValidationError(openai.APIResponseValidationError):  # type: ignore
    def __init__(
        ...
        self.message = "{}.APIResponseValidationError: {}".format(label, message)
        self.llm_provider = llm_provider
        self.model = model
        request = httpx.Request(method="POST", url="https://api.openai.com/v1")
...
class UnsupportedParamsError(BadRequestError):
    def __init__(
        ...
        self.status_code = 400
        self.message = "{}.UnsupportedParamsError: {}".format(label, message)
        self.model = model
        self.llm_provider = llm_provider
        self.litellm_debug_info = litellm_debug_info
...
class MockException(openai.APIError):
    ...
    def __init__(
        ...
        self.status_code = status_code
        self.message = "{}.MockException: {}".format(label, message)
        self.llm_provider = llm_provider
        self.model = model
        self.litellm_debug_info = litellm_debug_info
        self.max_retries = max_retries
